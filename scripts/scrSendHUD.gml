...
{
    buffer_write(global.tx_buff_server, buffer_u8, global.player_score[i])
    buffer_write(global.tx_buff_server, buffer_u8, global.player_health[i])
    buffer_write(global.tx_buff_server, buffer_u8, global.player_ammo[i])
}
